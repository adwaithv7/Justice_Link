					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">FIR History</h2>
							</header>
...
$sql="SELECT tbluser.FullName,tbluser.MobileNumber,tbluser.Email,tblfir.FIRNo,tblfir.ID,tblfir.Status,tblfir.DateofFIR from tblfir join tbluser on tblfir.UserID=tbluser.ID where tblfir.UserID='$uid' ";
...
{               ?>
                                    <tr style="font-size: 15px">
                                        ...
                                        <td class="font-w600">
                                            <?php  echo htmlentities($row->DateofFIR);?>
                                        </td>
<td class="font-w600">
<?php if($row->Status==""){ ?>
