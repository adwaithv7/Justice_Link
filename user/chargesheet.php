...
<html class="fixed">
	<head>
		...
		<title>Justice Link | New FIR</title>
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Charge</span></li>
								<li><span>Sheet</span></li>
							</ol>
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								<h2 class="panel-title">View Charge Sheet</h2>
							</header>
...
$sql="SELECT tbluser.FullName,tbluser.MobileNumber,tbluser.Email,tblfir.FIRNo,tblfir.ID,tblfir.Status,tblfir.DateofFIR from tblfir join tbluser on tblfir.UserID=tbluser.ID where (tblfir.Status='Charge Sheet Completed') && tblfir.UserID =:uid";
...
<?php } ?></td>
                                         <td class="d-none d-sm-table-cell"><a href="chargesheet-details.php?editid=<?php echo htmlentities ($row->ID);?>" class="btn btn-primary btn-sm">View Details</td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} else{  ?> 
                                    	<tr>
                                    	<th style="color:red; text-align:center;" colspan="8">No Record found</th>
                                    </tr>
                                    <?php } ?>
