...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4>	
                                ...
                                <tbody>
             <?php
$sql="SELECT * from tblcriminal where CriminalID like '$sdata%' ||  Name like '$sdata%'";
...
{               ?>
                                    <tr style="font-size: 15px">
                                       	<td><?php echo htmlentities($cnt);?></td>
											...
											<td>
												<a href="view-criminal-detail.php?viewid=<?php echo htmlentities ($row->ID);?>" class="btn btn-primary btn-sm" target="_blank">View Details</a>
