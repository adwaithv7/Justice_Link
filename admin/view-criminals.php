...
<html class="fixed">
	<head>
		<title>Justice Link | View Criminals</title>
...
{               ?>
										<tr>
											...
											<td>
												<a href="view-criminal-detail.php?viewid=<?php echo htmlentities ($row->ID);?>" class="btn btn-primary btn-sm">View Details</a>
