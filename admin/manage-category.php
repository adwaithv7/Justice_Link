...
<html class="fixed">
	<head>
		...
		<title>Justice Link | Manage Category</title>
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Manage Crime Categories</h2>
							</header>
...
{               ?>
										<tr>
											...
											<td>
												<a href="edit-category-detail.php?editid=<?php echo htmlentities ($row->ID);?>" class="btn btn-primary" target="_blank">Edit </a>
