...
<html class="fixed">
	<head>
		...
		<title>Justice Link | Criminals Reports</title>
...
<hr />
                                ...
                                <tbody>
             <?php
$sql="SELECT * from tblcriminal where date(RecordDate) between '$fdate' and '$tdate'";
...
{               ?>
                                    <tr style="font-size: 15px">
                                       	<td><?php echo htmlentities($cnt);?></td>
											...
											<td>
												<a href="view-criminal-detail.php?viewid=<?php echo htmlentities ($row->ID);?>" target="_blank" class="btn btn-primary btn-sm">View Details</a>
