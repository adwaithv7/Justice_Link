...
<html class="fixed">
	<head>
		...
		<title>Justice Link | Search Criminals</title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Between Dates FIR Reports</h2>
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								<h3>Between Dates <span class="table-project-n">FIR Reports</span></h3>
...
?>
<h3 align="center" style="color:blue">FIR Report from <?php echo $fdate?> to <?php echo $tdate?></h3>	
<hr />
...
$sql="SELECT tbluser.FullName,tbluser.MobileNumber,tbluser.Email,tblfir.FIRNo,tblfir.ID,tblfir.Status,tblfir.DateofFIR from tblfir join tbluser on tblfir.UserID=tbluser.ID where date(tblfir.DateofFIR) between '$fdate' and '$tdate'";
...
<?php } ?>                           </td>
                                         <td class="d-none d-sm-table-cell"><a href="view-fir-details.php?editid=<?php echo htmlentities ($row->ID);?>" class="btn btn-primary btn-sm"> View Details</td>
                                    </tr>
