...
<?php } ?>
                                         ...
                                         <td class="d-none d-sm-table-cell"><a href="view-search-fir.php?editid=<?php echo htmlentities ($row->ID);?>" class="btn btn-primary btn-sm" target="_blank">View Details</td>
                                    </tr>
