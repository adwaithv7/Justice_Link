...
<html class="fixed">
	<head>
		...
		<title>Justice Link | FIR between dates report</title>
...
where date(tblfir.DateofFIR) between '$fdate' and '$tdate' and   PoliceStationId=:psid";
...
$cnt=$cnt+1;
  ...
  <tr>
    <td colspan="8"> No record found against these date</td>
