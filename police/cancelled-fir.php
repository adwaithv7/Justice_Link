...
<html class="fixed">
	<head>
		...
		<title>Justice Link | Rejected/ Canceled FIR</title>
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Rejected/ Canceled</span></li>
								<li><span>FIR</span></li>
							</ol>
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								<h2 class="panel-title">Rejected/ Canceled FIR</h2>
							</header>
...
where tblfir.Status='Cancelled' and PoliceStationId=:psid";
